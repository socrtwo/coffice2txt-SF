package Spreadsheet::XLSX::Utility2007PDP;
...
# This allows declaration	use Spreadsheet::XLSX::Utility2007PDP ':all';
...
#==============================================================================
# Spreadsheet::XLSX::Utility2007::PDP;
#==============================================================================
...
#NENGO(Japanese)
                ...
                $sRep = Spreadsheet::XLSX::ZipMod2::FmtJapan::CnvNengo(1, @aTime);
            }
            elsif($rItem->[0] eq 'ggge') {
                $sRep = Spreadsheet::XLSX::ZipMod2::FmtJapan::CnvNengo(2, @aTime);
            }
            elsif($rItem->[0] eq '@') {
                $sRep = $iData;
            }
...
my $oBook = Spreadsheet::XLSX::ZipMod2 -> new($filename);
# my $oExcel = new Spreadsheet::XLSX::ZipMod2 ;
...
Spreadsheet::XLSX::Utility2007PDP - Perl extension for blah blah blah
...
Stub documentation for Spreadsheet::XLSX::Utility2007PDP, created by h2xs. It looks like the
