...
$wordalternatives -> command(-label =>"S2 Services Word Recovery - freeware for doc and docx text and format recovery", -command => [\&s2serviceswordrecoveryClicked, "S2 Services Word Recovery - freeware for doc and docx text and format recovery"]);
...
$wordalternatives -> command(-label =>"Corrupt MS Office 2007/2010/2013 Extractor - docx, xlsx and pptx repair freeware", -command => [\&cptOfficeRecoveryClicked, "Corrupt MS Office 2007/2010/2013 Extractor - docx, xlsx and pptx repair freeware"]);
...
$wordalternatives -> command(-label =>"Kernel Recovery for Word - doc/docx recovery commercialware - use coupon \"cnspot20\" for 20% off", -command => [\&kernelForWordClicked, "Kernel Recovery for Word - doc/docx recovery commercialware - use coupon \"cnspot20\" for 20% off"]);
$wordalternatives -> command(-label =>"eRepair for Word/Recovery Toolbox for Word - doc and docx recovery commercialware", -command => [\&recoverytoolboxforwordClicked, "eRepair for Word/Recovery Toolbox for Word - doc and docx recovery commercialware"]);
$wordalternatives -> command(-label =>"Repair Word Documents Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon", -command => [\&recoveronixWordServiceClicked, "Repair Word Document Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon"]);
$wordalternatives -> command(-label =>"Contact Me - upload corrupt files for manual recovery", -command => [\&sendToMeClicked, "Contact Me - upload corrupt docx document for manual recovery"]);
...
$excelalternatives -> command(-label =>"S2 Services Excel Recovery - freeware for xls and xlsx recovery", -command => [\&excelRecoveryClicked, "S2 Services Excel Recovery - freeware for xls and xlsx recovery"]);
$excelalternatives -> command(-label =>"Corrupt MS Office 2007/2010/2013 Extractor - docx, xlsx and pptx repair freeware", -command => [\&cptOfficeRecoveryClicked, "Corrupt MS Office 2007/2010/2013 Extractor - docx, xlsx and pptx repair freeware"]);	
...
$excelalternatives -> command(-label =>"Kernel Recovery for Excel - doc/docx recovery commercialware - try coupon \"cnspot20\" for 20% off", -command => [\&kernelForExcelClicked, "Kernel Recovery for Excel - doc/docx recovery commercialware - try coupon \"cnspot20\" for 20% off"]);
$excelalternatives -> command(-label =>"eRepair for Excel/Recovery Toolbox for Excel - doc and docx recovery commercialware", -command => [\&recoverytoolboxforexcelClicked, "eRepair for Excel/Recovery Toolbox for Excel - doc and docx recovery commercialware"]);
...
$excelalternatives -> command(-label =>"Repair Excel Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon", -command => [\&recoveronixExcelServiceClicked, "Repair Excel Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon"]);	
$excelalternatives -> command(-label =>"Contact Me - upload corrupt files for manual recovery", -command => [\&sendToMeClicked, "Contact Me - upload corrupt docx document for manual recovery"]);
my $powerpointalternatives = $alternatives -> cascade(-label =>"PowerPoint Recovery", -underline => 0, -tearoff => 0);
$powerpointalternatives -> command(-label =>"Microsoft's Steps to Recovering from PowerPoint corruption - ppt and (maybe) pptx recovery advice", -command => [\&powerpointStepsClicked, "Microsoft's Steps to Recovering from PowerPoint corruption - ppt and (maybe) pptx recovery advice"]);
$powerpointalternatives -> command(-label =>"Corrupt MS Office 2007/2010/2013 Extractor - docx, xlsx and pptx repair freeware", -command => [\&cptOfficeRecoveryClicked, "Corrupt MS Office 2007/2010/2013 Extractor - docx, xlsx and pptx repair freeware"]);
$powerpointalternatives -> command(-label =>"Kernel Recovery for PowerPoint - commercial software for ppt and pptx recovery", -command => [\&kernelForPowerPointClicked, "Kernel Recovery for PowerPoint - commercial software for ppt and pptx recovery"]);
...
$powerpointalternatives -> command(-label =>"Repair PowerPoint Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon", -command => [\&recoveronixPowerPointServiceClicked, "Repair PowerPoint Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon"]);
$powerpointalternatives -> command(-label =>"Contact Me - upload corrupt files for manual recovery", -command => [\&sendToMeClicked, "Contact Me - upload corrupt docx document for manual recovery"]);
my $openofficealternatives = $alternatives -> cascade(-label =>"Open Office Recovery", -underline => 0, -tearoff => 0);
$openofficealternatives -> command(-label =>"10 Free Ways to Recover Open Office - corrupt odt, ods and odp recovery advice", -command => [\&openOfficeStepsClicked, "10 Free Ways to Recover Open Office - corrupt odt, ods and odp recovery advice"]);
...
$openofficealternatives -> command(-label =>"Repair OO Writer Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon", -command => [\&recoveronixOpenOfficeWriterServiceClicked, "Repair OO Writer Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon"]);
...
$openofficealternatives -> command(-label =>"Repair OO Calc Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon", -command => [\&recoveronixOpenOfficeCalcServiceClicked, "Repair OO Calc Online - now free until 11-01-2014 - do a demo recovery and use \"S2SERVICES\" coupon"]);
$openofficealternatives -> command(-label =>"Contact Me - upload corrupt files for manual recovery", -command => [\&sendToMeClicked, "Contact Me - upload corrupt docx document for manual recovery"]);
...
$help -> command(-label =>"About and Instructions", -command => sub { 
	...
	3.  If you chose a salvage method, your extracted text will be 
	displayed. If you chose a the Full Recovery choice the application 
	will attempt to launch a recovered version with the software currently 
	assigned as the default for the corrupt file's extension, odt, ods 
	or odp.
	4.  If you chose a Salvage method, you can Edit, the text as desired.
	5.  With salvaged text, choose the Save menu choice on the File Menu 
	and file to the name and file location you wish.
	...
	anything but basic formatting for Microsoft Office files through the 
	previously mentioned text extractions although links are provided on 
	the Alternatives menu. This program can be used as a viewer of text 
	within healthy MS Office and Open Office files without having Open 
	Office installed. 
	
	The text extraction is accomplished with the use of the command line
	application, SILVERCODERS DocToText, CMD Corrupt OfficeOpen2txt, 
	Apache Tika and The Chicago Project extract. Write me for details 
	about which is used for which extraction or look at the source in the 
	Source folder. The reconstructed version of the Open Office file is 
	accomplished by unzipping the Open Office file with the somewhat zip 
	corruption immune 7z.exe unzipper. Once unzipped, the manifest/
	manifest.xml file is replaced with a greatly simplified version as 
	described here: 
	http://www.oooforum.org/forum/viewtopic.phtml?t=57600.
	If this application doesn't work, for Open Office files there are 
	other things worth trying as summarized here:
	http://s2services.com/open_office.htm
	and other choices on the Alternatives Menu. Also check 
	out the Alternatives Menu for other things to try for MS Office files 
	including fotmat recovery freeware listed there.
	
							 ----Changes to 1.0.3----
	1. Brought the S2SERVICES coupon expiration date up to the right date:
	11/01/2014.
	2. Changed URL's of my software to point to the Sourceforge location.
	
	                         ----Changes to 1.0----
	
	1. Added a zip repair pretreatment using InfoZip zip.exe -FF 
	command for all zip based file recoveries.
	2. New icon.
	3. Using 7zip as the the archive extractor now instead of CakeCMD 
	or No Frills unzipper although the CMD Corrupt OfficeOpen2txt still
	uses the same libraries as No-Frills unzipper did.
	4. Preserved the do_not_remove folder with its manifest.xml contents 
	during the installation routine. This issue and the next one originally 
	prevented the corrupt Open Office recovery feature working in version 
	0.22.
	5. Also fixed the preserving of the unzipped folder and its 
	sevenzipcmd.exe contents as well as the support dll files in the 
	installation routine.
	6. Made a custom version of Apache Tika which only recovers text 
	Word doc and PowerPoint ppt files which uses Java JRE 1.5 which 
	is also included in its most bare bones fashined as allowed by 
	the Java license.
	...
	xlhtml and ppthml from The Chicago project, the Apache Tika Project, 
	Java JRE 1.5, CMD Corrupt OfficeOpen2txt, No-Frills Unzipper, 
	Nirsoft's HTMLAsText, 7zip and InfoZip's Zip.  
	
	Here are the links:
	
	* DocToText: http://silvercoders.com/en/products/doctotext
	* Xlhtml and Ppthtml: http://prdownloads.sf.net/chicago/
	xlHtml-Win32-040.zip
	* CMD Corrupt OfficeOpen2txt: http://godskingsandheroes.info/software/coffec_cmd.zip
	software/3
	* No-Frills Unzipper: http://godskingsandheroes.info/software/no-frills-unzipper.zip 
	...
	* InfoZip's Zip: http://www.info-zip.org/
	* Apache Tika: http://tika.apache.org/
	* Java JRE 1.5: http://bit.ly/n0mEYQ
	...
	* You can upload files also to another of my sites: 
	http://www.saveofficedata.com/contact.htm
...
sub menuOpenClickedExtract1 {
	...
	my @file_type   = split(/\./, $usNamedUnderScoreLowerCaseBaseName);
	...
	if($file_type eq 'ppt'){	
		...
		open $wfh, "| tikapptdoc.exe -t $randomName > $salvagedText 2> $processing" or warn "Unable to use rt to extract text from $randomName to $salvagedText.$nl";
		close $wfh;
	...
	sub menuOpenClickedExtract2 {
		...
		my @file_type2 = split(/\./, $usNamedUnderScoreLowerCaseBaseName2);
		...
		if($file_type2 eq 'ppt'){
			...
			} elsif ($file_type2 eq 'xls'){	
			
			#
				# Xlhtml.exe extracts and converts the ppt to HTML. 
				# This is a different method than the previous use
				# of DocToText for extracting data from xls files.
			#	
			
			open $wfh, "| xlhtml.exe $randomName2 > $salvagedhtml 2> $processing" or warn "Unable to use xlhtml to extract text from $underScoreLowerCaseBaseName.$nl";
			close $wfh;
			
			#
				# Again, I don't know what these lines do except maybe create an 
				# html document. I don't know where I got the code either...
			#	
			...
			#
				#  Again I guess this code extracts text from the html file.
			#
			
			my $texthtmlname = "text.html";
			copy($salvagedhtml, $texthtmlname) or warn "Unable to copy $underScoreLowerCaseBaseName to text.html.$nl";
			print "$texthtmlname$nl";
			my $textname = "text.txt";
			open $wfh, "| HtmlAsText.exe /run \"$cfgabspath\" 2> $processing" or warn "Unable to use HtmlAsText.exe to extract text from the html results file produced by xlhtml.exe.$nl";
			close $wfh;
			...
			#
				# Processing all the files with zip structure chosen with File Extract II Dialog Box. Those  
				# are the extensions docx, xlsx, pptx, odt, ods and odp. Doc files will be processed with 
				# this code as well and result in an error. I have to find another command line text extractor.
			#	
			} elsif ($file_type2 eq 'xlsx') {
			
			my $csvstoragefoldername = 'sheets_recovered_from_' . $lowerCaseBaseName2;
			my $csvstoragefolderpath = $lowerCaseDirectoryName2 . "\\" . $csvstoragefoldername;
			mkdir $csvstoragefolderpath;
			use Cwd;
			...
			open $wfh, "| coffec.exe -t \"$randomNamedZipRepairedFilePath2\" > extract_II_console_output.txt 2>extract_II_error2.txt" or warn "Unable to convert $randomNamedZipRepairedFilePath2 to CSV files$nl";
			close $wfh;
			
			chdir $temp_dir;
			use File::Copy;
			for ( glob '*.csv' ) {
				move $_, $csvstoragefolderpath;
			}
			...
			If successful this mode will extract	
			the recoverable worksheets and their
			data into csv files named with the 
			worksheet names and saved into 
			a folder named \'sheets_recovered_
			from_\' and the name of your corrupt
			file and located in the directory 
			from where you selected it.');
			...
			} elsif ($file_type2 eq 'doc') {
			
			#
				# This alternate method for method for extracting text from doc file uses the Apache Tika project.
			#
			
			open $wfh, "| tikapptdoc.exe -t $randomName2 > $salvagedText2 2> $processing" or warn "Unable to use rt to extract text from $randomName2 to $salvagedText2.$nl";
			close $wfh;
		...
		sub openOfficeFormatRecovered {
			...
			my $zipRepairedFilePath3  =  $temp_dir . "\\zip_Repaired3_" . $underScoreLowerCaseBaseName3; 
			
			system ("cmd /c zip.exe -FF \"$usNamedUnderScoreLowerCaseBaseName3\" --out \"$zipRepairedFilePath3\" ");
			
			#
				# unzipping of the zip repaired Open Office Text file.
			#
			
			open $wfh, "| 7z.exe x \"$zipRepairedFilePath3\" -y -ounzipped " or warn "Unable to unzip $zipRepairedFilePath3 with 7zip.$nl";
			close $wfh;		
		...
		sub recoverytoolboxforwordClicked {
			
			my $url = "http://www.plimus.com/jsp/redirect.jsp?contractId=2326426&referrer=socrtwo";
			my $commandline = qq{start "$url" "$url"}; 	# Launches link to eRepair Word/Recovery Toolbox for Word with my affiliate ID. Get your own ID to see sales credited to you.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
			
		}
		
		sub recoverytoolboxforexcelClicked {
			
			my $url = "http://www.plimus.com/jsp/redirect.jsp?contractId=2264308&referrer=socrtwo";
			my $commandline = qq{start "$url" "$url"}; 	# Launches link to eRepair Excel/Recovery Toolbox for Word with my affiliate ID. Get your own ID to see sales credited to you.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
			
		}
		
		sub s2serviceswordrecoveryClicked  {
			
			my $url = "http://sourceforge.net/projects/wordrecovery/";
			my $commandline = qq{start "$url" "$url"}; 	# Launches link to my software, S2 Recovery Tools for Microsoft Word.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub savvyWordRecoveryClicked {
			...
			my $url = "http://sourceforge.net/projects/quickwordrecovr/";
			my $commandline = qq{start "$url" "$url"}; 	# Launches link to my software, Savvy DOCX Recovery.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub repairMyWordClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	# launches link to the freeware RepairMyWord.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub wordStepsClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	# Launches link to my corrupt Word file repair/recovery advice.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
			
		}
		
		sub powerpointStepsClicked {
			
			my $url = "http://office.microsoft.com/en-us/powerpoint-help/recover-a-corrupt-powerpoint-file-HA001116878.aspx";
			my $commandline = qq{start "$url" "$url"}; 	# Launches Microsoft's advice for recovering from corrupt PowerPoint files.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub cptOfficeRecoveryClicked {
			...
			my $url = "http://sourceforge.net/projects/crrptoffcxtrctr/";
			my $commandline = qq{start "$url" "$url"}; 	# Launches link to my software, Corrupt Extractor for Microsoft Office.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub corruptOpenOfficeRecoveryClicked {
			...
			my $url = "http://sourceforge.net/projects/oorecovery/";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches link to my software, Corrupt Open Office Salvager.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub kernelForWordClicked{
			
			my $url = "http://esd.element5.com/product.html?productid=300136781&stylefrom=300338460";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recovery for Excel's Web page with
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub kernelForExcelClicked{
			
			my $url = "http://esd.element5.com/product.html?productid=300136778&stylefrom=300338460";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recovery for Excel's Web page with
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub kernelForPowerPointClicked{
			
			my $url = "http://esd.element5.com/product.html?productid=300136784&stylefrom=300338460";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recovery for PowerPoint's Web page with
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub recoveryForOpenOfficeWriterClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recovery for Open Office's Web page with
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub recoveryForOpenOfficeCalcClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recovery for Open Office Calc's Web page with
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub recoveronixWordServiceClicked{
			my $response2 = $mw->messageBox(-icon => 'question', -message => "Until Nov 1, 2014, for a free \$39 value file repair attempt, first go through Demo recovery with your corrupt file on the Online Office Recovery site that is about to open. After recovery, scroll down past \"Demo Results\" and enter the coupon code S2SERVICES in the field above the \"Submit Code\" button at the end of the \"Full Results\" section. Use all caps for the code but don't include the quotes.", -title => 'Instructions for Using the S2SERVICES Coupon for Free Corrupt Recovery', -type => 'OK', -default => 'OK');
		...
		sub recoveronixExcelServiceClicked{
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recoveronix' Excel online recovery with 
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub recoveronixPowerPointServiceClicked{
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recoveronix' PowerPoint online recovery with 
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub recoveronixOpenOfficeWriterServiceClicked{
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recoveronix' Open Office Writer online recovery with 
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub recoveronixOpenOfficeCalcServiceClicked{
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches Recoveronix' Open Office Calc online recovery with 
			# my affiliate ID. Be sure to get your own.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub sendToMeClicked {
			...
			my $commandline = qq{start "$url" "$url"};  # Launches my contact form where users can upload their files to me for manual recovery.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub wordFixClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	 # Launches WordFix product page with my affiliate ID 622 :-). 
		...
		sub corruptDocxSalvagerClicked {
			...
			my $url = "https://sourceforge.net/projects/damageddocx2txt/";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches  a link to my software Corrupt DOCX Salvager.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub excelStepsClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	# Launches  a link to my page offering advice on corrupt Excel repair.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub openOfficeStepsClicked {
			...
			my $commandline = qq{start "$url" "$url"}; 	# Launches a link to my advice on recovering from corrupt Open Office repair.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub excelRecoveryClicked {
			...
			my $url = "https://sourceforge.net/projects/corruptexcelrec/";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches link to my software, Excel Recovery.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
		...
		sub corruptXlsxSalvagerClicked {
			...
			my $url = "https://sourceforge.net/projects/corruptxlsx2csv/";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches a link to my software Corrupt XLSX Salvager.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
			
		}					
		
		sub s2serviceswordrecovery {
			
			my $url = "http://sourceforge.net/projects/wordrecovery/";
			my $commandline = qq{start "$url" "$url"}; 	 # Launches a link to my software S2 Services Word Recovery.
			system($commandline) == 0
			or die qq{Couldn't launch '$commandline': $!/$?};
