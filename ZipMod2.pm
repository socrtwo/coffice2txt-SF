package Spreadsheet::XLSX::ZipMod2;
...
sub new {
	...
	my $ZipMod2_temp_sharedStrings_path = $temp_dir . "\\xl\\sharedStrings.xml";
	open FILE, "<$ZipMod2_temp_sharedStrings_path";
...
my $ZipMod2_temp_styles_path = $temp_dir . "\\xl\\styles.xml";
open FILE, "<$ZipMod2_temp_styles_path";
...
my $ZipMod2_temp_workbook_path = $temp_dir . "\\xl\\workbook.xml";
open FILE, "<$ZipMod2_temp_workbook_path";
$file_contents = do { local $/; <FILE> };
close FILE;
my $member_workbook = $file_contents;
	...
	foreach my $sheet (@Worksheet) {
		...
		my $ZipMod2_temp_member_name  = $temp_dir . "\\xl\\worksheets/sheet$sheet->{Id}.xml";
		open FILE, "<$ZipMod2_temp_member_name";
		$file_contents = do { local $/; <FILE> };
		close FILE;
...
Spreadsheet::XLSX::ZipMod2 - Perl extension for reading MS Excel 2007 files;
...
=head1 SYNOPSIS
 ...
 use Spreadsheet::XLSX::ZipMod2;
 
 my $excel = Spreadsheet::XLSX::ZipMod2 -> new ('test.xlsx', $converter);
